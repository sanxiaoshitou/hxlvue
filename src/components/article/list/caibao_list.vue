        ...
        <div style="overflow: hidden;">
            ...
            <div class="article-main" id="main">
                ...
                <div class="article-list" v-for="(article, i) in dataList" :key="i">
                    ...
                    <ul>
                        <h3>
                            <router-link tag="a" :to="{path:'/cbDetails',query:{msgUrl:article.msgUrl}}">
                                {{article.title}}
                            </router-link>
                        </h3>
                        <p>
                ...
                <br>
                <!--分页-->
                <Page :total="dataCount" :current="pageNum" :page-size="10" @on-change="load" show-total />
            </div>
            <!--侧栏-->
            <Side></Side>
...
<script>
    import {caiBaoList} from '../../../api/data'
    ...
    export default {
        ...
        data() {
            return {
                //分页文献：https://blog.csdn.net/u013144287/article/details/78879044
                dataList: [],//数据
                dataCount: 0,//总数
                pageNum: 1,
                pageSize: 10,//条数
